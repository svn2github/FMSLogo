		...
		<div id="main">
			<article>
				...
				<ul>
					...
					There is a thumbnail sketch of how to setup a build environment at <a href="https://sourceforge.net/p/fmslogo/source/HEAD/tree/logo/trunk/HOWTO-BUILD.TXT">HOWTO-BUILD.TXT</a>.
					To my knowledge, only a few people have ever compiled FMSLogo, so don't expect this to be easy.
					...
					I hope to port FMSLogo to GNU/Linux some day, but that could be years from now.
