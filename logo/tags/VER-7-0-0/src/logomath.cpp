...
{
#if __GNUC__ == 6 && __GNUC_MINOR__ < 4 && !defined DEBUG
    // Work around https://gcc.gnu.org/bugzilla/show_bug.cgi?id=71020
    // until the fix is available in Fedora Core 25.
    err_logo(DK_HOW_UNREC, NIL);
#else
