...
ElapsedTime::ElapsedTime() {
	...
	if (usePerformanceCounter) {
		...
		bigBit = timeVal.u.HighPart;
		littleBit = timeVal.u.LowPart;
	} else {
		bigBit = clock();
	}
}
...
double ElapsedTime::Duration(bool reset) {
	...
	if (usePerformanceCounter) {
		...
		endBigBit = lEnd.u.HighPart;
		endLittleBit = lEnd.u.LowPart;
		LARGE_INTEGER lBegin;
		lBegin.u.HighPart = bigBit;
		lBegin.u.LowPart = littleBit;
