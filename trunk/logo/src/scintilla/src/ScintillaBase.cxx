...
void ScintillaBase::ContextMenu(Point pt) {
	if (displayPopupMenu) {
		...
		popup.CreatePopUp();
		AddToPopUp(LOCALIZED_POPUP_UNDO,   idcmdUndo, writable && pdoc->CanUndo());
		AddToPopUp(LOCALIZED_POPUP_REDO,   idcmdRedo, writable && pdoc->CanRedo());
		AddToPopUp("");
		AddToPopUp(LOCALIZED_POPUP_CUT,    idcmdCut, writable && currentPos != anchor);
