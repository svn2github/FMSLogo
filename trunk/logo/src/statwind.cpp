...
void CStatusWindow::SetupWindow()
   ...
   SetDlgItemText(ID_STATUS_CONTACT,     LOCALIZED_STATUS_CONTACT);
   SetDlgItemText(ID_STATUS_PENCOLOR,    LOCALIZED_STATUS_PENCOLOR);
   SetDlgItemText(ID_STATUS_FLOODCOLOR,  LOCALIZED_STATUS_FLOODCOLOR);
   SetDlgItemText(ID_STATUS_SCREENCOLOR, LOCALIZED_STATUS_SCREENCOLOR);
   SetDlgItemText(ID_STATUS_PALETTE,     LOCALIZED_STATUS_PALETTE);
   SetDlgItemText(ID_STATUS_WIDTH,       LOCALIZED_STATUS_WIDTH);
   SetDlgItemText(ID_STATUS_POSITION,    LOCALIZED_STATUS_POSITION);
   SetDlgItemText(ID_STATUS_WHICH,       LOCALIZED_STATUS_WHICH);
   SetDlgItemText(ID_STATUS_VISIBILITY,  LOCALIZED_STATUS_VISIBILITY);
   SetDlgItemText(ID_STATUS_STYLE,       LOCALIZED_STATUS_STYLE);
   SetDlgItemText(ID_STATUS_HEADING,     LOCALIZED_STATUS_HEADING);
   SetDlgItemText(ID_STATUS_PITCH,       LOCALIZED_STATUS_PITCH);
   SetDlgItemText(ID_STATUS_ROLL,        LOCALIZED_STATUS_ROLL);
   SetDlgItemText(ID_STATUS_PEN,         LOCALIZED_STATUS_PEN);
   SetDlgItemText(ID_STATUS_ORIENTATION, LOCALIZED_STATUS_ORIENTATION);
   SetDlgItemText(ID_STATUS_TURTLE,      LOCALIZED_STATUS_TURTLE);
   SetDlgItemText(ID_STATUS_COLOR,       LOCALIZED_STATUS_COLOR);
   SetDlgItemText(ID_STATUS_KERNEL,      LOCALIZED_STATUS_KERNEL);
   SetDlgItemText(ID_STATUS_CALLS,       LOCALIZED_STATUS_CALLS);
   SetDlgItemText(ID_STATUS_PEAKMEMORY,  LOCALIZED_STATUS_PEAKMEMORY);
