...
//    { "goto", 1, 1, 1, MACRO_PRIORITY, lgoto },
      ...
      { "netacceptoff", 0, 0, 0, PREFIX_PRIORITY, lnetreceiveoff },
      { "netaccepton", 3, 3, 3, PREFIX_PRIORITY, lnetreceiveon },
      { "netacceptreceivevalue", 0, 0, 0, PREFIX_PRIORITY, lnetreceivereceivevalue },
      { "netacceptsendvalue", 1, 1, 1, PREFIX_PRIORITY, lnetreceivesendvalue },
      { "netconnectoff", 0, 0, 0, PREFIX_PRIORITY, lnetsendoff },
      { "netconnecton", 4, 4, 4, PREFIX_PRIORITY, lnetsendon },
      { "netconnectreceivevalue", 0, 0, 0, PREFIX_PRIORITY, lnetsendreceivevalue },
      { "netconnectsendvalue", 1, 1, 1, PREFIX_PRIORITY, lnetsendsendvalue },
...
//    { "scan", 1, 1, 1, PREFIX_PRIORITY, lscan },
...
//    { "setcursor", 1, 1, 1, PREFIX_PRIORITY, lsetcursor },
 ...
 //   { "silent", 0, 0, 0, PREFIX_PRIORITY, lsilent },
...
//    { "unsilent", 0, 0, 0, PREFIX_PRIORITY, lunsilent },
