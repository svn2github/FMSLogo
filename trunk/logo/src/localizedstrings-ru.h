...
#define LOCALIZED_FILEFILTER_ALLFILES "Все файлы (*.*)\0*.*\0" 
#define LOCALIZED_FILEFILTER_LOGO     "Лого-файлы (*.lgo)\0*.lgo\0"LOCALIZED_FILEFILTER_ALLFILES 
#define LOCALIZED_FILEFILTER_IMAGE    "Растровые файлы (*.bmp)\0*.bmp\0GIF-файлы (*.gif)\0*.gif\0"LOCALIZED_FILEFILTER_ALLFILES 
