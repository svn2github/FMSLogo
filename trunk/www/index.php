		...
		<div id="main">
			<article>
				...
				<ul>
					...
					<li>Text in all available system fonts</li>
					<li>1024 independent turtles</li>
					<li>Bitmapped turtles</li>
					<li>MIDI devices</li>
					<li>Direct I/O for controlling external hardware (must be admin)</li>
					<li>Serial and parallel port communications</li>
					<li>Saving and loading images in BMP format</li>
					<li>Calling into native DLLs</li>
					<li>Creating windows dialog boxes</li>
					<li>Event driven programming (mouse, keyboard, timer)</li>
					<li>Controlling multimedia devices (WAV sound files, CD-ROM control, etc.)</li>
				...
				<ul>
					...
					<li>FMSLogo runs fine on computers that are 10 years old.</li>
					<li>FMSLogo has a strong, international user community with over a decade of classroom experience.</li>
				</ul>
